...
def parse_arguments():
    """コマンドライン引数をパースする"""
    parser = argparse.ArgumentParser(description='Claudeプロンプトツール')
    ...
    parser.add_argument('-t', '--temperature', type=float, default=0.7, help='温度（デフォルト: 0.7）')
